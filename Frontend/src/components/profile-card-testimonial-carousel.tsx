...
const testimonials: Testimonial[] = [
  {
    ...
    linkedinUrl:
      "https://www.linkedin.com/in/adilakshmi-vemaala-6490bb342?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app",
  },
  {
    name: "Intiaz Shaik",
    ...
    linkedinUrl:
      "https://www.linkedin.com/in/intiaz-shaik-ba45891b8?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app",
  },
  {
          ...
          <button
            ...
            className={cn(
              ...
              currentIndex === index
                ...
                : "hover:-translate-y-0.5 opacity-60 hover:opacity-100",
            )}
          >
            <div
              className={cn(
